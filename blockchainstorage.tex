...
\usetikzlibrary{shapes, arrows, positioning, calc, patterns, decorations.pathreplacing, mindmap,automata, chains}
...
\figProgramFlow{Program Flow}{This figure show btcd's execution. Following it from btcdMain which is btcd's main function called shortly after actual main. To many of the goroutine that continually run in the background doing work.}
